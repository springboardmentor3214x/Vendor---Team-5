...
@Component({
  ...
  styles: [`
    .messages-page{color:var(--vr-navy)} .workspace{display:grid;grid-template-columns:minmax(240px,285px) minmax(0,1fr);min-height:475px;border:1px solid var(--vr-border);border-radius:15px;background:#fff;overflow:hidden;box-shadow:0 8px 20px rgba(15,23,42,.06)}
    .conversation-list{background:#fff7f8;border-right:1px solid var(--vr-border);padding:.7rem;overflow:auto}.list-heading,.thread-header{display:flex;align-items:center;justify-content:space-between;gap:.6rem}.list-heading h3,.thread-header h3{margin:0;font-size:.98rem}.icon-button{display:grid;place-items:center;border:1px solid #fecdd3;border-radius:8px;width:30px;height:30px;background:#fff;color:var(--vr-primary)}
    .conversation{display:flex;width:100%;align-items:flex-start;gap:.55rem;padding:.6rem;margin-top:.45rem;border:1px solid transparent;border-radius:11px;background:transparent;text-align:left}.conversation:hover,.conversation.selected{background:#fff;border-color:#fecdd3;box-shadow:0 3px 10px rgba(225,29,72,.05)}.avatar{display:grid;place-items:center;width:30px;height:30px;flex:0 0 30px;border-radius:50%;background:#ffe4e6;color:#9f1239;font-size:.85rem;font-weight:800}.conversation-copy{display:grid;min-width:0;flex:1;gap:.1rem}.conversation-copy strong,.conversation-copy small{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.conversation-copy small,time{color:var(--vr-muted);font-size:.7rem}.unread{display:grid;place-items:center;min-width:20px;height:20px;padding:0 .25rem;border-radius:99px;background:var(--vr-primary);color:#fff;font-size:.66rem;font-weight:800}.compact{padding:.75rem;font-size:.8rem}
    .thread-panel{display:flex;min-width:0;flex-direction:column;background:#fffafb}.thread-header{padding:.75rem .9rem;border-bottom:1px solid var(--vr-border)}.secure-label{border-radius:99px;padding:.24rem .45rem;background:#ecfdf5;color:#166534;font-size:.67rem;font-weight:700}.thread{flex:1;min-height:285px;padding:.85rem;overflow:auto;background:linear-gradient(135deg,#fff7f8,#fff)}.bubble{max-width:min(78%,620px);margin:.4rem 0;padding:.6rem .72rem;border:1px solid #fee2e2;border-radius:12px 12px 12px 3px;background:#fff;box-shadow:0 2px 8px rgba(31,41,55,.04)}.bubble.own{margin-left:auto;border-color:#fecdd3;border-radius:12px 12px 3px 12px;background:#fff1f2}.bubble p{margin:0;white-space:pre-wrap}.bubble footer{display:flex;justify-content:flex-end;gap:.4rem;margin-top:.25rem;color:var(--vr-muted);font-size:.66rem}.composer{display:grid;grid-template-columns:1fr auto;gap:.55rem;padding:.75rem;border-top:1px solid var(--vr-border);background:#fff}.composer textarea{min-height:46px;resize:vertical}.thread-loading,.select-prompt{display:grid;place-content:center;flex:1;min-height:320px;padding:1.25rem;text-align:center;color:var(--vr-muted)}.select-prompt h3{color:var(--vr-navy)}
